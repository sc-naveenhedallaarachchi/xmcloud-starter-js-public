...
describe('Image Component', () => {
  ...
  describe('Default Image Component', () => {
    ...
    it('should render with correct container structure', () => {
      ...
      const container = screen.getByTestId('image-field').closest('.component.image');
  ...
  describe('Banner Image Component', () => {
    ...
    it('should render image with link when target URL is provided', () => {
      ...
      const image = link.querySelector('[data-testid="image-field"]');
      expect(image).toBeInTheDocument();
    });
  ...
  describe('Component structure', () => {
    it('should render correct DOM structure for Default component', () => {
      ...
      const image = contentDiv?.querySelector('[data-testid="image-field"]');
      expect(image).toBeInTheDocument();
    });
